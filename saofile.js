    ...
    async completed() {
        ...
        if (this.answers.createSchema) {
            ...
            if (!hasPkg) {
                ...
                if (this.testingMode) {
                    package.scripts['deploy:prepare'] = 'del -rf node_modules/.tmp/prisma-appsync/ && mkdir -p node_modules/.tmp/prisma-appsync/dist/ && cp -R node_modules/prisma-appsync/dist/ node_modules/.tmp/prisma-appsync/dist/'
